      ...
      <div className="mx-auto max-w-4xl px-6">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <motion.div
              animate={{ opacity: 1, y: 0 }}
              className="group overflow-hidden rounded-2xl border border-border bg-background transition-all hover:border-[#DD8A46] hover:shadow-lg"
              initial={{ opacity: 0, y: INITIAL_Y_OFFSET }}
              key={faq.question}
              transition={{
            ...
            >
              ...
              >
                <h3 className="pr-4 font-prestisemibold text-foreground text-lg">
                  {faq.question}
                </h3>
                <motion.div
                  animate={{
